...
public class RegisterationUser {
	...
	public static void main(String[] args) {
		...
		WebElement loginSection=driver.findElement(By.xpath("//h2[contains(text(), 'Guru99 Bank')]"));
		...
		String expSectionTitleText= "Guru99 Bank";
		...
		driver.findElement(By.xpath("//td[contains(text(), 'Manger Id : mngr376214')]")).getText();
		System.out.println(driver.findElement(By.xpath("//td[contains(text(), 'Manger Id : mngr376214')]")).getText());
